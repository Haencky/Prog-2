...
public class IntSuchbaum {
     ...
     */
    private void insert(int i, Knoten k) {
     ...
     * @return true falls vorhanden, false sonst
     */
    private boolean contains(int i, Knoten k) {
     ...
     */
    private Folge<Integer> traverse(Knoten k, String art) {
        //Anlegen einer Folge
        Folge<Integer> s = new FolgeMitDynArray<>();
     ...
     * @return Queue der Breitensuche
     */
    private Folge<Integer> breitensuche(Knoten k) {
        //Anlegen der Queue
        Folge<Integer> queue = new FolgeMitDynArray<>();
     ...
     */
    private void remove(Knoten p, Knoten k, int i) {
        if (k == null)
            return;
        else if (i < k.value) {
    ...
    /**
     * Private Hilfsmethode zum Finden des kleinsten Knotens,
     * der Größer als der ursprüngliche ist
     * @param k ursprünglicher Knoten
     * @return Kleinster Knoten größer k
     */
    private Knoten findMinimum(Knoten k) {
        Knoten tmp = k;
        while (tmp.l != null)
            tmp = tmp.l;
        return tmp;
